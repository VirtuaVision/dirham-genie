 ...
 * that discount fraction — e.g. 0.5 keeps only 50%+ off items. This is the
 * piece that was missing before: without it, a minDiscount request from
 * the caller was silently ignored and nothing was actually filtered.
 */
