...
// Saving a product can also trigger a full social post (screenshot capture
// + Facebook + Instagram + WhatsApp) in the same request when "auto-post"
// is checked. Instagram alone can take up to ~45s to be allowed to
// publish, plus up to ~40s for the screenshot — comfortably under 300s
// (Hobby's ceiling), but well past a default/unset timeout, which is
// exactly why this needs to be declared explicitly.
