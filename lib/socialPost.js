 ...
 * fully propagated, producing a "media is not available" error. Waiting
 * until the URL actually resolves avoids that race.
 */
 ...
 * publish it. Retries the container-creation step once after a short delay
 * if it fails — Instagram occasionally can't fetch a freshly-uploaded image
 * on the first try even after our own readiness check passes.
 */
