...
export const BLOCK_TYPES = {
    ...
    fields: [
      {
        ...
        options: [
          ...
          { value: "image", label: "Background Image (heading/codes/button still show on top)" },
        ],
      },
      { key: "image", label: "Background image — 1200×400px, wide banner (3:1). Your heading, codes, and button render on top of it.", type: "image", default: "" },
      ...
      { key: "couponCode", label: "Coupon code(s) — separate multiple codes with a comma, e.g. SAVE10, WELCOME20", type: "text", default: "" },
  ...
  split_banner: {
    ...
    fields: [
      { key: "leftImage", label: "Left banner image — square, e.g. 600×600px", type: "image", default: "" },
      { key: "leftHeading", label: "Left heading", type: "text", default: "" },
      { key: "leftLink", label: "Left link", type: "text", default: "/category" },
      { key: "rightImage", label: "Right banner image — square, e.g. 600×600px", type: "image", default: "" },
  ...
  triple_image_banner: {
    ...
    fields: [
      { key: "image1", label: "Banner 1 image — square, e.g. 500×500px", type: "image", default: "" },
      { key: "link1", label: "Banner 1 link", type: "text", default: "/category" },
      { key: "image2", label: "Banner 2 image — square, e.g. 500×500px", type: "image", default: "" },
      { key: "link2", label: "Banner 2 link", type: "text", default: "/category" },
      { key: "image3", label: "Banner 3 image — square, e.g. 500×500px", type: "image", default: "" },
    ...
    fields: [
      {
        ...
        options: [
          { value: "gradient", label: "Gradient Card" },
          { value: "image", label: "Background Image (heading/button still show on top)" },
        ],
      },
      { key: "image", label: "Background image — 1200×400px, wide banner (3:1). Your heading and button render on top of it.", type: "image", default: "" },
  ...
  social_follow_banner: {
    ...
    description: "Rounded pill bar with your logo, colored platform icons, and a tagline.",
    fields: [
      { key: "heading", label: "Brand name (shown next to 'Follow')", type: "text", default: "Dirham Genie" },
      { key: "tagline", label: "Tagline (shown below the bar)", type: "text", default: "Your destination for the best Amazon UAE deals & trending finds." },
      ...
      { key: "linkedinLink", label: "LinkedIn link (leave blank to hide)", type: "text", default: "" },
      { key: "youtubeLink", label: "YouTube link (leave blank to hide)", type: "text", default: "" },
      { key: "telegramLink", label: "Telegram link (leave blank to hide)", type: "text", default: "" },
  ...
  brand_spotlight_banner: {
    ...
    fields: [
      ...
      { key: "image", label: "Background image — 1200×400px, wide banner (3:1). Your heading and button render on top of it.", type: "image", default: "" },
      { key: "brandLogo", label: "Brand logo (optional, shown in Gradient style) — square, e.g. 200×200px", type: "image", default: "" },
  ...
  feature_cards: {
    label: "Feature Cards",
    description: "The 3-card row: Daily Deals, Creators Choice, Limited Time Offers.",
    fields: [
      ...
      { key: "card2_image", label: "Creators Choice image (optional) — 600×300px, landscape (2:1)", type: "image", default: "" },
      { key: "card2_link", label: "Creators Choice link", type: "text", default: "/creators-choice" },
  ...
  creators_choice: {
    ...
    description: "A hand-picked grid — shows products marked 'Creators Choice' in Add Product.",
    fields: [
      { key: "heading", label: "Section heading", type: "text", default: "✨ Creators Choice" },
      { key: "limit", label: "How many products", type: "number", default: 8 },
    ],
  },
  product_grid: {
